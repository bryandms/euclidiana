...
@section('title', 'Sexo del estudiante')
  ...
  <div class="row">
    <div class="card col-12">
      <div class="card-body">
        ...
        <h5>Instrucciones</h5>
        <p>Se pretende identificar el sexo del estudiante. Para esto debe elegir su estilo de aprendizaje, recinto de origen y su promedio de matrícula.</p>
            ...
            <div class="card-body">
              <form id="genderForm">
                ...
                <div class="col-12 d-flex justify-content-center mt-3">
                  <button type="button" onclick="getGender();" class="btn btn-dark btn-sm">Calcular</button>
                </div>
              </form>
              <h4 id="result" class="mt-3">Tu género es: 
